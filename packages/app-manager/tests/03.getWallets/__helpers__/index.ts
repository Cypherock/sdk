...
import { IGetWalletsTestCase } from '../__fixtures__/types';

export function setupMocks(testCase: IGetWalletsTestCase) {
...
export function expectMockCalls(testCase: IGetWalletsTestCase) {
