import { byteUnstuffing, intToUintByte } from '../bytes';
import { radix as allRadix } from '../config';
import { crc16 } from '../utils/crc';
import { PacketVersionMap } from '../utils/versions';

const START_OF_FRAME = '01';
const END_OF_TRANSMISSION = '04';
const CHUNK_SIZE = 256;
const radix = allRadix.v1;
...
export const stmXmodemDecode = (param: Buffer) => {
