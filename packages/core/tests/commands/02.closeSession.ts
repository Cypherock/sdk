...
import { describe, test, afterEach, jest, beforeEach } from '@jest/globals';
import { expectMockCalls, setupMocks } from './__helpers__';
import { SDK } from '../../src';
import fixtures from './__fixtures__/closeSession';

describe('sdk.closeSession', () => {
  ...
  describe('should be able to close session', () => {
