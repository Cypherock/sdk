const HARDENED_BASE = 0x80000000;

const LEGACY_PURPOSE = HARDENED_BASE + 44;
const SEGWIT_PURPOSE = HARDENED_BASE + 84;

const BITCOIN_COIN_INDEX = HARDENED_BASE + 0;
const DASH_COIN_INDEX = HARDENED_BASE + 5;
