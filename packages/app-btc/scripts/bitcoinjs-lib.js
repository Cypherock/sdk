  ...
  return (function () {
  ...
  })()(
    {
        ...
        function (require, module, exports) {
          ...
          class SHA2 extends utils_js_1.Hash {
            ...
            _cloneInto(to) {
              ...
              to.set(...this.get());
              const { blockLen, buffer, length, finished, destroyed, pos } =
                this;
              to.length = length;
              to.pos = pos;
      ...
      4: [
        function (require, module, exports) {
           ...
           */
          exports.ripemd160 = (0, utils_js_1.wrapConstructor)(
            () => new RIPEMD160(),
          );
        },
        { './_sha2.js': 2, './utils.js': 7 },
      ],
      5: [
        function (require, module, exports) {
          'use strict';
    ...
    0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19
        ...
        function (require, module, exports) {
          ...
          function randomBytes(bytesLength = 32) {
            if (
              ...
              return crypto_1.crypto.getRandomValues(
      ...
      14: [
        ...
        {
          '../typeFields': 39,
          './global/globalXpub': 12,
          './global/unsignedTx': 13,
          './input/finalScriptSig': 15,
          './input/finalScriptWitness': 16,
          './input/nonWitnessUtxo': 17,
          './input/partialSig': 18,
          './input/porCommitment': 19,
          './input/sighashType': 20,
          './input/tapKeySig': 21,
          './input/tapLeafScript': 22,
          './input/tapMerkleRoot': 23,
          './input/tapScriptSig': 24,
          './input/witnessUtxo': 25,
          './output/tapTree': 26,
          './shared/bip32Derivation': 27,
          './shared/checkPubkey': 28,
          './shared/redeemScript': 29,
          './shared/tapBip32Derivation': 30,
          './shared/tapInternalKey': 31,
          './shared/witnessScript': 32,
        },
      ],
      15: [
        function (require, module, exports) {
      ...
      25: [
        ...
        { '../../typeFields': 39, '../tools': 33, '../varint': 34, buffer: 73 },
      ],
      26: [
        function (require, module, exports) {
          (function (Buffer) {
        ...
        { '../../typeFields': 39, '../varint': 34, buffer: 73 },
      ],
      27: [
        function (require, module, exports) {
          (function (Buffer) {
      ...
      30: [
        ...
        { '../varint': 34, './bip32Derivation': 27, buffer: 73 },
      ],
      31: [
        function (require, module, exports) {
          (function (Buffer) {
      ...
      37: [
        ...
        { '../converter': 14, '../converter/tools': 33, buffer: 73 },
      ],
      38: [
        function (require, module, exports) {
          (function (Buffer) {
      ...
      40: [
        function (require, module, exports) {
          (function (Buffer) {
                  ...
                  for (const name of Object.keys(updateData)) {
                    ...
                    if (check) {
                      if (isArray) {
                        ...
                        if (
                          !data.every(v => canAddToArray(arr, v, dupeCheckSet))
                        ) {
                          throw new Error(
            ...
            isBuffer: require('../../../../../is-buffer@1.1.6/node_modules/is-buffer/index.js'),
          });
        },
        {
          '../../../../../is-buffer@1.1.6/node_modules/is-buffer/index.js': 75,
          './converter': 14,
        },
      ],
      41: [
      ...
      44: [
        ...
        { './types': 69, buffer: 73, 'varuint-bitcoin': 81 },
      ],
      45: [
        function (require, module, exports) {
          (function (Buffer) {
            (function () {
              ...
              function ripemd160(buffer) {
                return Buffer.from(
                  (0, ripemd160_1.ripemd160)(Uint8Array.from(buffer)),
                );
              }
              exports.ripemd160 = ripemd160;
              ...
              exports.TAGGED_HASH_PREFIXES = {
                'BIP0340/challenge': Buffer.from([
                  123, 181, 45, 122, 159, 239, 88, 50, 62, 177, 191, 122, 64,
                  110, 199, 158, 160, 212, 153, 2, 148, 240,
                ]),
                'KeyAgg coefficient': Buffer.from([
                  191, 201, 4, 3, 77, 28, 136, 232, 200, 14, 34, 229, 61, 36,
                  86, 109, 100, 130, 78, 214, 66, 114, 129, 192, 145, 0, 249,
                  77, 205, 82, 201, 129, 191, 201, 4, 3, 77, 28, 136, 232, 200,
                  14, 34, 229, 61, 36, 86, 109, 100, 130, 78, 214, 66, 114, 129,
                  192, 145, 0, 249, 77, 205, 82, 201, 129,
                ]),
              };
              function taggedHash(prefix, data) {
                return sha256(
                  Buffer.concat([exports.TAGGED_HASH_PREFIXES[prefix], data]),
                );
              }
      ...
      51: [
        ...
        { '../networks': 48, '../script': 65, '../types': 69, './lazy': 53 },
      ],
      52: [
        function (require, module, exports) {
          'use strict';
              ...
              function p2sh(a, opts) {
                ...
                const _redeem = lazy.value(() => {
                  ...
                  return {
                    network,
                    output:
                      lastChunk === OPS.OP_FALSE ? Buffer.from([]) : lastChunk,
        ...
        function (require, module, exports) {
          ...
          function p2tr(a, opts) {
            ...
            lazy.prop(o, 'pubkey', () => {
              ...
              if (o.internalPubkey) {
                const tweakedKey = (0, bip341_1.tweakKey)(
                  o.internalPubkey,
                  o.hash,
                );
      ...
      61: [
            ...
            (function () {
              ...
              class Psbt {
                ...
                finalizeTaprootInput(
                  ...
                  throw new Error(
                    `Cannot finalize input #${inputIndex}. Not Taproot.`,
                  );
                }
                _finalizeInput(
                  inputIndex,
                ...
                validateSignaturesOfTaprootInput(
                  ...
                  if (
                    !input &&
                    !tapKeySig &&
                    !(tapScriptSig && !tapScriptSig.length)
                  )
                    throw new Error('No signatures to validate');
                  if (typeof validator !== 'function')
                    throw new Error(
                ...
                signTaprootInput(
                  ...
                  throw new Error(
                    `Input #${inputIndex} is not of type Taproot.`,
                  );
                }
                _signInput(
                  inputIndex,
              ...
              function prepareFinalScripts(
                ...
                if (isSegwit) {
                  if (p2wsh) {
                    finalScriptWitness = (0,
                    psbtutils_1.witnessStackToScriptWitness)(p2wsh.witness);
                  } else {
                    finalScriptWitness = (0,
                    psbtutils_1.witnessStackToScriptWitness)(payment.witness);
                  }
              ...
              function getPrevoutTaprootKey(inputIndex, input, cache) {
                ...
                return (0, psbtutils_1.isP2TR)(script)
              ...
              function getTaprootHashesForSig(
                ...
                if (input.tapInternalKey && !tapLeafHashToSign) {
                  const outputKey =
                    getPrevoutTaprootKey(inputIndex, input, cache) ||
                    Buffer.from([]);
                ...
                const tapLeafHashes = (input.tapLeafScript || [])
                  ...
                  .filter(
                    tapLeaf =>
                      !tapLeafHashToSign ||
                      tapLeafHashToSign.equals(tapLeaf.hash),
                  )
                  .map(tapLeaf => {
              ...
              function getScriptAndAmountFromUtxo(inputIndex, input, cache) {
                if (input.witnessUtxo !== undefined) {
                  ...
                  const o =
                    nonWitnessUtxoTx.outs[cache.__TX.ins[inputIndex].index];
              ...
              function pubkeyInInput(pubkey, input, inputIndex, cache) {
                ...
                return (0, psbtutils_1.pubkeyInScript)(
                  pubkey,
                  meaningfulScript,
                );
              }
              ...
              function getMeaningfulScript(
                ...
                const isP2SHP2WSH =
                  isP2SH &&
                  redeemScript &&
                  (0, psbtutils_1.isP2WSHScript)(redeemScript);
        ...
        },
        {
          ...
          './transaction': 68,
          bip174: 38,
          'bip174/src/lib/converter/varint': 34,
          'bip174/src/lib/utils': 40,
          buffer: 73,
        },
      ],
      62: [
            ...
            (function () {
              ...
              function tapScriptFinalizer(
                ...
                try {
                  ...
                  return {
                    finalScriptWitness: (0,
                    psbtutils_1.witnessStackToScriptWitness)(witness),
                  };
                } catch (err) {
                  throw new Error(
              ...
              function isTaprootOutput(output, script) {
                return (
                  ...
                  !!(
                    ...
                    output.tapTree ||
                    (output.tapBip32Derivation &&
                      output.tapBip32Derivation.length) ||
              ...
              function checkTaprootInputFields(
                ...
                checkMixedTaprootAndNonTaprootInputFields(
                  inputData,
                  newInputData,
                  action,
                );
              ...
              function checkTaprootInputForSigs(input, action) {
                ...
                return sigs.some(sig =>
                  (0, psbtutils_2.signatureBlocksAction)(
                    sig,
              ...
              function _tapTreeToList(tree, leaves = [], depth = 0) {
                ...
                if ((0, types_1.isTapleaf)(tree)) {
                  leaves.push({
                    depth,
                    leafVersion:
                      tree.version || bip341_1.LEAF_VERSION_TAPSCRIPT,
                    script: tree.output,
                  });
                  return leaves;
                }
              ...
              function instertLeafInTree(leaf, tree, depth = 0) {
                ...
                const leftSide = instertLeafInTree(
                  leaf,
                  tree && tree[0],
                  depth + 1,
                );
                if (leftSide) return [leftSide, tree && tree[1]];
                const rightSide = instertLeafInTree(
                  leaf,
                  tree && tree[1],
                  depth + 1,
                );
              ...
              function checkMixedTaprootAndNonTaprootInputFields(
                ...
                const isBadTaprootUpdate =
                  isTaprootInput(inputData) &&
                  hasNonTaprootFields(newInputData);
                const isBadNonTaprootUpdate =
                  hasNonTaprootFields(inputData) &&
              ...
              function checkIfTapLeafInTree(inputData, newInputData, action) {
                if (newInputData.tapMerkleRoot) {
                  const newLeafsInTree = (
                    newInputData.tapLeafScript || []
                  ).every(l => isTapLeafInTree(l, newInputData.tapMerkleRoot));
                  ...
                  const newLeafsInTree = (
                    newInputData.tapLeafScript || []
                  ).every(l => isTapLeafInTree(l, inputData.tapMerkleRoot));
                  if (!newLeafsInTree)
                    throw new Error(
                      `Invalid arguments for Psbt.${action}. Tapleaf not part of taptree.`,
                    );
              ...
              function canFinalizeLeaf(leaf, tapScriptSig, hash) {
                ...
                return (
                  whiteListedHash &&
                  tapScriptSig.find(tss => tss.leafHash.equals(leafHash)) !==
                    undefined
                );
              }
      ...
      73: [
        ...
        { 'base64-js': 9, buffer: 73, ieee754: 74 },
      ],
      74: [
        function (require, module, exports) {
