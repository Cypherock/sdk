...
import { ConstellationApp } from '../../src/index';

describe('ConstellationApp.create', () => {
  ...
  test('should be able to create constellation app instance', async () => {
    await ConstellationApp.create(connection);
