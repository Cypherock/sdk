        ...
        class StrykerJestEnvironment extends JestEnvironmentClass {
            constructor(config, context) {
                ...
                this.handleTestEvent = async (event, eventState) => {
                    ...
                    if (messaging_js_1.state.coverageAnalysis === 'perTest') {
                ...
                this.strykerContext = this.global[(_b = this.global.__strykerGlobalNamespace__) !== null && _b !== void 0 ? _b : '__stryker__'] = messaging_js_1.state.instrumenterContext;
                messaging_js_1.state.testFilesWithStrykerEnvironment.add(context.testPath);
            }
        }
        _a = STRYKER_JEST_ENV;
